...
.bg::before,.bg::after{
  content:"";position:absolute;width:120vmax;height:120vmax;border-radius:0;
...
.card{position:relative;
  ...
  border:1px solid var(--line); border-radius:0; padding:38px 32px 30px;
  box-shadow:0 40px 90px -30px rgba(0,0,0,.95);
}
.card::before{content:"";position:absolute;top:-1px;left:-1px;right:-1px;height:2px;background:linear-gradient(90deg,var(--accent),transparent 62%)}
.lock{
...
input{
  width:100%;padding:14px 15px;border-radius:0;border:1px solid var(--line);
...
button{
  width:100%;margin-top:16px;padding:14px;border:0;border-radius:0;cursor:pointer;
...
.err{
  ...
  border-radius:0;border:1px solid rgba(255,45,85,.34);background:rgba(255,45,85,.09);
